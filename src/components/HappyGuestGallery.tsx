          ...
          >
            {guestImages.map((img, idx) => (
              <motion.div 
                ...
                className="relative flex-none shrink-0 w-[calc((100%-16px)/2)] md:w-[calc((100%-3*24px)/4)] aspect-[3/4] rounded-2xl md:rounded-[2rem] overflow-hidden bg-slate-200 shadow-xl group snap-start"
              >
                <img 
