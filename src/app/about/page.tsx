...
import { Target, Eye, Users, Award, Shield, Clock, FileText, Scale, MapPin } from 'lucide-react';
        ...
        <section className="py-24 bg-slate-900 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-8 bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl flex items-start gap-5">
