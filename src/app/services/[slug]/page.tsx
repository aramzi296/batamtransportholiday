      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">Layanan Tidak Ditemukan</h1>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col lg:flex-row gap-16">
              ...
              <div className="lg:w-2/3">
                <div className="mb-12">
                  <h2 className="text-3xl font-display font-bold text-slate-900 mb-6">Deskripsi Layanan</h2>
                ...
                <div>
                  <h2 className="text-3xl font-display font-bold text-slate-900 mb-8">Fitur & Keunggulan</h2>
              ...
              <div className="lg:w-1/3">
                <div className="sticky top-28">
                  <div className="bg-white rounded-[2.5rem] p-8 shadow-2xl border border-slate-100 relative overflow-hidden">
                    ...
                    <p className="text-slate-500 font-bold uppercase tracking-wider text-sm mb-2">Estimasi Harga</p>
                    ...
                    <div className="mt-8 pt-8 border-t border-slate-100">
                      <h5 className="font-bold text-slate-900 mb-4 text-sm uppercase tracking-widest">Kenapa Kami?</h5>
