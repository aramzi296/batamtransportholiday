...
export const en: Dictionary = {
  ...
  about: {
    ...
    subtitle: "About Us",
    description: "Batam Transport Holiday is here as a leading transportation and tourism solution in Batam, combining comfort, safety, and local hospitality.",
    stats: [
  ...
  legality: {
    ...
    valueName: "PT Batam Transport Holiday",
