...
<div class="container-fluid">
    <div class="row">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('message') is-invalid @enderror" 
                                          ...
                                          placeholder="Tulis testimoni pelanggan di sini..." required>{{ old('message') }}</textarea>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">Tips Testimoni</h6>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        <h6><i class="fas fa-lightbulb"></i> Tips untuk Testimoni yang Baik:</h6>
                        <ul class="mb-0 small">
                            <li>Gunakan nama asli pelanggan</li>
                            <li>Tulis testimoni yang spesifik dan jujur</li>
                            <li>Sertakan lokasi untuk kredibilitas</li>
                            <li>Foto berkualitas baik akan lebih menarik</li>
                            <li>Rating harus sesuai dengan isi pesan</li>
                            <li>Testimoni unggulan akan muncul lebih dulu</li>
                        </ul>
                    </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <p class="mb-0 small">
                            Pastikan testimoni yang dimasukkan adalah asli dari pelanggan.
                            Testimoni palsu dapat merusak reputasi bisnis.
                        </p>
                    </div>
                </div>
            </div>
        ...
        reader.onload = function(e) {
            preview.innerHTML = `
                <div class="mt-2">
                    ...
                    <div class="small text-muted mt-1">Preview foto</div>
                </div>
            `;
        };
