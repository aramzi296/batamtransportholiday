...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.vehicles.update', $vehicle) }}" method="POST" enctype="multipart/form-data">
            ...
            <!-- Existing Images -->
            @if($vehicle->vehicleImages && $vehicle->vehicleImages->count() > 0)
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <a href="{{ route('admin.vehicles.show', $vehicle) }}" class="btn btn-info me-2">
                ...
                reader.onload = function(e) {
                    ...
                    previewDiv.innerHTML = `
                        ...
                        <div class="form-check mt-2 text-center">
                            ...
                            <label class="form-check-label small" for="featured_new_${index}">
                                Jadikan Fitur
                            </label>
                        </div>
                    `;
