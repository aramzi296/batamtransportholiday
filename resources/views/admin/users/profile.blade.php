...
@section('title', 'Profil Anggota - ' . $user->name)
@section('page-title', 'Profil Anggota')

@section('content')
<div class="card">
    <div class="card-header bg-info text-white">
        <h5 class="mb-0"><i class="fas fa-id-card"></i> Profil Anggota - {{ $user->name }}</h5>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('admin.users.profile.update', $user->id) }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <small class="text-muted">Nama tidak dapat diubah. Silakan ubah di Edit User.</small>
                </div>
                <div class="col-md-6">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" id="email" value="{{ $user->email }}" disabled>
                    <small class="text-muted">Email tidak dapat diubah. Silakan ubah di Edit User.</small>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('nomor_whatsapp') is-invalid @enderror" 
                           ...
                           value="{{ old('nomor_whatsapp', $dataAnggota['nomor_whatsapp'] ?? $user->nomor_whatsapp) }}" 
                           placeholder="Contoh: 081234567890">
