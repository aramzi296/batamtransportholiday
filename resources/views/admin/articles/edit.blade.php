...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4>Edit Artikel: {{ $article->title }}</h4>
        <p class="text-muted">Perbarui konten artikel</p>
    </div>
    <div>
        @if($article->status === 'published')
            <a href="{{ url('/articles/' . $article->slug) }}" class="btn btn-outline-primary me-2" target="_blank">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                  ...
                                  placeholder="Ringkasan singkat artikel (opsional, akan di-generate otomatis jika kosong)">{{ old('excerpt', $article->excerpt) }}</textarea>
                        @error('excerpt')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    ...
                    <div id="imagePreview" style="{{ $article->featured_image ? 'display: block;' : 'display: none;' }}">
                        <img id="previewImg" src="{{ $article->featured_image }}" alt="Preview" class="image-preview">
                    </div>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-chart-line"></i> Statistik Artikel</h5>
                </div>
                <div class="card-body">
...
// Set initial content
@if(old('content', $article->content))
...
@if($article->featured_image)
    previewImage('{{ $article->featured_image }}');
@endif
</script>
@endpush
@endsection