    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.faqs.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="rich-text-editor">
                    ...
                    <div id="answer-editor" 
                         ...
                         oninput="updateHiddenInput()">{{ old('answer') }}</div>
                    <textarea name="answer" id="answer-hidden" class="d-none" required>{{ old('answer') }}</textarea>
                </div>
                @error('answer')
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary" onclick="updateHiddenInput(); return true;">
